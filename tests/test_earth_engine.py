...
class TestGetEmbedding:
    ...
    def test_get_embedding_success(self, mock_ee):
        ...
        # Test the function
        result = get_embedding(39.0372, -121.8036, 2024)
    ...
    def test_get_embedding_no_image_found(self, mock_ee):
        ...
        # Return None to simulate no image found
        mock_bounds_filtered.first.return_value = None
        
        # Test that ValueError is raised
        with pytest.raises(ValueError, match="No embedding found for 39.0372,-121.8036 at year 2024"):
            get_embedding(39.0372, -121.8036, 2024)
    ...
    def test_get_embedding_with_different_coordinates(self, mock_ee):
        ...
        # Test with different coordinates and year
        result = get_embedding(40.0, -120.0, 2023)
