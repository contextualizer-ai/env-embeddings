...
gh-add-topics:
  gh repo edit --add-topic "env-embeddings,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/contextualizerai/env-embeddings/collaborators/dragon-ai-agent -X PUT -f permission=push
