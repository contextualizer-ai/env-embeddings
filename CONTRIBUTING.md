# Contributing to env-embeddings

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
env-embeddings. These guidelines are not strict rules.
...
The env-embeddings team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the env-embeddings technical leads
...
[issues]: https://github.com/contextualizerai/env-embeddings/issues/
[pulls]: https://github.com/contextualizerai/env-embeddings/pulls/
